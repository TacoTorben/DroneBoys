...
: ${AMENT_CURRENT_PREFIX:="/home/dksoren/drone_boys/install/drone"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/drone/environment/library_path.sh"
